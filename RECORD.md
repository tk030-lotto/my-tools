...
| [`data/tools.json`](file:///c:/Users/tk030/Desktop/公開ツール一覧サイト/data/tools.json) | ツールマスターデータ（原本 / 現在21件登録済み） |
...
1. **画像をまとめてリサイズする単機能ツール「Image Resizer」**（公開日: 2026-09-10 / カテゴリ: AI開発 / Web版あり）
2. **ロト＆ナンバーズ 統合構造解析・出目表可視化ツール**（公開日: 2026-09-06 / カテゴリ: その他 / Web版あり）
3. **「引き継いでみよう。」**（公開日: 2026-09-04 / カテゴリ: AI開発 / Web版あり）
4. **「公開してみよう。」**（公開日: 2026-09-01 / カテゴリ: AI開発 / Web版あり）
5. **「もう一回作ってみよう。」**（公開日: 2026-08-30 / カテゴリ: AI開発 / Web版あり）
6. **レシピの分量変更、もう計算しなくていい。CookScaleを作りました**（公開日: 2026-08-30 / カテゴリ: AI開発 / Web版あり）
7. **「次に何する？」**（公開日: 2026-08-29 / カテゴリ: AI開発 / Web版あり）
8. **「これでいいの？」**（公開日: 2026-08-27 / カテゴリ: AI開発 / Web版あり）
9. **エラーで止まらない。**（公開日: 2026-08-26 / カテゴリ: AI開発 / Web版あり）
10. **まず動かしてみよう。**（公開日: 2026-08-24 / カテゴリ: AI開発 / Web版あり）
11. **分からないなら、AIに聞いてみよう。**（公開日: 2026-08-23 / カテゴリ: AI開発 / Web版あり）
12. **「何を作るか決めよう。」**（公開日: 2026-08-21 / カテゴリ: AI開発 / Web版あり）
13. **躊躇してないで、とにかく作ってみよう。**（公開日: 2026-08-17 / カテゴリ: AI開発 / Web版あり）
14. **GitHub公開前チェッカー**（公開日: 2026-08-16 / カテゴリ: 開発支援）
15. **MyVoice Speech**（公開日: 2026-08-10 / カテゴリ: その他 / AI音声）
16. **ディレクトリ構造可視化ツール**（公開日: 2026-08-09 / カテゴリ: 開発支援）
17. **開発ツール集 (DevTools Suite)**（公開日: 2026-08-04 / カテゴリ: 開発支援）
18. **BaseKit Suite**（公開日: 2026-07-15 / カテゴリ: 開発支援）
19. **天体軌道アライメント診断**（公開日: 2026-06-23 / カテゴリ: その他 / シミュレーター）
20. **Simple SNS Kit**（公開日: 2026-06-15 / カテゴリ: その他）
21. **Office Automator**（公開日: 2026-05-28 / カテゴリ: ファイル・PC）
...
### 第5版 (2026-09-04): 同期スクリプトの誤除外防止（プロトコル問題解消）と新着ツールの自動同期
- **除外フィルターの誤判定バグ修正**:
  - `scripts/sync_tools.py` において、「ロト」という短いキーワードで全文検索を行っていたため、AI開発記事内の「プロトコル（protocol）」という開発用語に誤爆して新着記事が除外されていた問題を解消。
  - 正規表現による否定戻り読み・先読み（`(?<!プ)ロト(?!コル|タイプ)`）および宝くじ共起ワード判定を導入し、開発プロトコル記事を誤除外せずロト系記事のみを確実に除外する堅牢なロジックへ改善。
- **タイトル・サブタイトルの自動分離**:
  - `「...」` 形式のタイトルからツール名とサブタイトルを自動抽出し、UIカードの表示品質を向上。
